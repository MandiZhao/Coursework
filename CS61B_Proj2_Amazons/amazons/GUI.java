...
class GUI extends TopLevel implements View, Reporter {
    ...
    GUI(String title) {
        ...
        addMenuButton("Settings->Manual Black", this::manualBlk);
        addMenuButton("Settings->Auto Black", this::autoBlk);
        addMenuButton("Settings->Manual White", this::manualWte);
        addMenuButton("Settings->Auto White", this::autoWte);
    ...
    /** Click button "manual black". */
    private void manualBlk(String dummy) {
        _pendingCommands.offer("manual black");
    }

    /** Click button "manual white". */
    private void manualWte(String dummy) {
        _pendingCommands.offer("manual white");
    }

    /** Click button "auto black". */
    private void autoBlk(String dummy) {
        _pendingCommands.offer("auto black");
    }

    /** Click button "auto white". */
    private void autoWte(String dummy) {
