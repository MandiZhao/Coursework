...
final class Controller {
    ...
    private Command[] _commands = {
        ...
        new Command("auto\\s+(?i:black)", this::doAutoB),
        new Command("auto\\s+(?i:white)", this::doAutoW),
        new Command("manual\\s+(?i:black)", this::doManualB),
        new Command("manual\\s+(?i:white)", this::doManualW),
    };
    ...
    /** Command of a move, e.g. "a1 a3 b3". Use MAT to input */
    ...
    /** Make black player play. */
    private void doAutoB(Matcher unused) {
        _black = _autoPlayerTemplate.create(BLACK, this);
    }

    /** Make white player play. */
    private void doAutoW(Matcher unused) {
        _white = _autoPlayerTemplate.create(WHITE, this);
    }

    /** Make black manual player play. */
    private void doManualB(Matcher unused) {
        _black = _manualPlayerTemplate.create(BLACK, this);
    }

    /** Make white manual player play. */
    private void doManualW(Matcher unused) {
        _white = _manualPlayerTemplate.create(WHITE, this);
    }
