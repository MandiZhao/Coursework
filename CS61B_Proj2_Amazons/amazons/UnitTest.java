...
public class UnitTest {
    ...
    /** Test the handle of strings in Square class. */
    @Test
    public void testSquareStrings() {
        assertEquals("a1", Square.sq(0).toString());
        assertEquals("j9", Square.sq("j9").toString());
    ...
    public void testUnblockedMove() {
        Board b = new Board();
        b.put(Piece.BLACK, Square.sq("j10"));
        System.out.println(b);
        assertTrue(b.isUnblockedMove(Square.sq("j10"),
                Square.sq("e10"), Square.sq("g10")));
    }
